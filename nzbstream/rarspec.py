...
#
#
# Modified by pleo to support RAR streams.  Also renamed to rarspec
#
...
__all__ = ['is_rarfile', 'RarInfo', 'RarSpec', 'RarExtFile']
...
class RarSpec(object):
    ...
    def __init__(self, rarfile, mode="r", charset=None, info_callback=None, crc_check=True, partial_ok=False, stream=False, parse=True):
